...
class Gdax(object):
    ...
    _rate_limits = {
        'public'    : 6,
        'private'   : 10,
        'financial' : '' # throttling (late commit)
    }
    _services = {
        'getAccounts'           : 'accounts',           # leading g=GET, p=POST
        'getAccount'            : 'accounts/{acc_id}',
        'getAccountHistory'     : 'accounts/{acc_id}/ledger',
